...
public class CreateHubRequest {
    ...
    @NotBlank(message = "위도(latitude)는 필수입니다.")
    @DecimalMin(value = "-90.0", message = "위도는 -90.0 이상이어야 합니다.")
    @DecimalMax(value = "90.0", message = "위도는 90.0 이하이어야 합니다.")
    private BigDecimal latitude;


    @NotBlank(message = "경도(longitude)는 필수입니다.")
    ...
    @Builder
    public CreateHubRequest(String name, String address, BigDecimal latitude, BigDecimal longitude) {
        this.name = name;
     ...
     //DTO를 도메인 모델(Entity 또는 VO)로 변환하는 메서드
     // Service 계층에서 Location VO와 Hub Entity를 생성하는 데 사용
